...
* **Chunking** - This mnemonic techinque helps enchance memory. We store the bare minimum details needed to remind us of some data with context and we can remember related bits of information. Colors of rainbow can be chunked as "VIBGYOR".
* **Elaborative encoding** -  Using this mnemonic technique you associate details with some piece of information so that it takes less cognitive load to recall it. These details can then be compressed to remember them more effectively. Say a group of people named Miller, Kim and Rivera, can be remembered as "guy with a windmill on his head, character from kim prossible are floating down a river". The details can be absurd as long as they supplement effective recall.
* **Mind Palace** - Associating abstract pieces of information with a physical place can help us remember the information more effectively. In this technique we place different pieces of information in different parts of an architecture we know and with repetition the whole structure can and the information within can be recalled actively. With practice we can memorise information in absurd detail like memorising 200 random numbers in sequence or a random deck of cards. Vivid visualisation is the key. .
* **Generation** - Forcing your brain to recall some piece of information by providing some context or deduction through logic can help us memorise the information better. Example are the fill in the blank quizzed of Kinnu.
